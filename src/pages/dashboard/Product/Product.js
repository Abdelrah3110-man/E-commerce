  ...
  useEffect(() => {
    ...
    Axios.get(`${PRODUCT}/${id}`)
      ...
      .catch((err) => {
        console.log(err);
        // setLoading(false);
        // navigate("/dashboard/products/page/404", { replace: true });
      });
  }, []);
  // categories
  useEffect(() => {
      ...
      <div className=" border p-2 position-relative ">
        <div className="d-flex  align-items-center">
          <div className="d-flex align-items-center justify-content-center">
            <img src={img.image} width={"160px"}></img>
          </div>
          <Button
            variant="danger"
            ...
            onClick={() => handelImageDeleteFromServer(img.id)}
          >
            X
          </Button>
        </div>
  ...
  return (
    <div className="bg-white w-100 mx-2 p-3">
      ...
      <Form className="my-4" onSubmit={handelEdit}>
        ...
        <div className="d-flex align-items-center  justify-content-center gap-4 mb-1 mt-1 flex-wrap">
          {imagesFromServerShow}
        </div>
        <div className="d-flex align-items-start flex-column gap-2 mb-1 mt-3">
          {imagesShow}
        </div>
        <button
